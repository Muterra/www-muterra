 ...
 * @version 1.0
 *
 * Modified by Nick Badger to... ham-fistedly fix bug with fixed width 
 * during window resize while using any kind of responsive layout.
 * I basically just commented out everything to do with width.
 * There's also a bug (that I didn't bother dealing with) where vertical
 * changes in element height affect the position calculation for when it
 * should stick, causing the stickiness to happen early or late.
 */
